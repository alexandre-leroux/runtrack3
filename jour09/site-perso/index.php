    ...
    <header>
      ...
      <div id="nav_et_rs">
        <nav>
          ...
          <button id="troisieme_boutton" class="lien_nav">porfolio</button>
          <button id="dernier_boutton" class="lien_nav">contact</button>
        </nav>

        <div id="div_reseaux_sociaux">
          <a target="_blank" href="https://fr.linkedin.com/in/alexandre-leroux-2023311a3"><img src="medias/rs/031-linkedin.png" alt="logo linkedin"></a>
          <a target="_blank" href="https://github.com/alexandre-leroux"><img src="medias/rs/039-github.png" alt="logo github"></a>
    ...
    <section id="section_centrale">
      ...
      <div id="accueil">
        ...
        <div class="type-js2 headline">
          <p id="text_hover2" class="text-js">je suis Alexandre,</p>
        </div>
